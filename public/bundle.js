...
/***/ function(module, exports, __webpack_require__) {
	...
	var name = 'Don',
	    msg = 'Hey, whats up!';
	ReactDOM.render(React.createElement(Greeter, { name: name, msg: msg }), document.getElementById('app'));
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'div',
					null,
					React.createElement('textarea', { ref: 'msg', placeholder: 'Enter Description' }),
					React.createElement('br', null)
				),
				React.createElement(
					'button',
